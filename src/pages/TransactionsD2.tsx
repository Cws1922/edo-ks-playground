...
import { InlineHint } from '@/components/transactions/EducationVariants';
import { HighlightCards } from '@/components/transactions/AboveTableCards';
import { FilterBar } from '@/components/transactions/FilterBar';
import { TRANSACTIONS, ALL_COLUMNS, type Transaction, type ColumnKey } from '@/data/transactions';

export default function TransactionsD2() {
  ...
  return (
    <TransactionShell>
      <div className="flex items-center gap-3 mb-1">
        ...
        <InlineHint initiallyOpen={false} />
        <span className="tiktok-labelSm bg-warning-fillLow text-warning-onFillLow px-2 py-0.5 rounded">
          D2 · Immersive Reading
        </span>
      </div>
      <KsText variant="bodySm" color="neutralLow">
        Spacious 72px rows · highlight cards above table · inline ⓘ hint
      </KsText>
